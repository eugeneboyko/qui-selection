...
a.length;b++)if(!this.isSelected(a[b]))return!1;return!0},isAnyItemSelected:function(a){for(var b=0;b<a.length;b++)if(this.isSelected(a[b]))return!0;return!1},selectAll:function(){this.__selectedItems=this.__allItems.splice()},deselectAll:function(){this.__selectedItems=[]},toggleAll:function(){this.isAllSelected()?this.deselectAll():this.selectAll()},isAllSelected:function(){return this.__selectedItems.length===this.__allItems.length},firstSelected:function(){return this.__selectedItems[0]}};Object.defineProperty(d.prototype,
"selectedItems",{get:function(){return this.__selectedItems},set:function(a){var b=[],c;for(c=0;c<this.__selectedItems.length;c++)-1===a.indexOf(this.__selectedItems[c])&&b.push(this.__selectedItems[c]);for(c=0;c<b.length;c++)this.deselect(b[c]);for(c=0;c<a.length;c++)this.select(a[c])}});Object.defineProperty(d.prototype,"allItems",{get:function(){return this.__allItems},set:function(a){this.deselectAll();this.__allItems=a}});Object.defineProperty(d.prototype,"selectionLimit",{get:function(){return this.__selectionLimit},
set:function(a){this.deselectAll();this.__selectionLimit=a}});return d});
